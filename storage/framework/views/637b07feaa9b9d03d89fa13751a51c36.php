        ...
        <div class="table-responsive-freeze show-shadow">
            <table class="table ts-table mb-0" id="mainTable">
                ...
                <tbody class="emp-block" data-no="<?php echo e($index + 1); ?>" data-name="<?php echo e(strtolower($emp->name)); ?>"
                    ...
                    <tr class="row-hk">
                        <td rowspan="3" class="sticky-left col-chk" style="background-color: #f8fafc;">
                        ...
                        <td rowspan="3" class="sticky-left col-no row-number"><?php echo e($index + 1); ?></td>
                        <td rowspan="3" class="sticky-left col-name">
                        ...
                        <td rowspan="3" class="bg-wages-brutto text-end pe-2">Rp
                            <?php echo e(number_format($totals['total_rp'], 0, ',', '.')); ?></td>
                        <td rowspan="3" class="bg-wages-netto text-end pe-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/bskp-gate-factory-cost/resources/views/sub-job/index.blade.php ENDPATH**/ ?>