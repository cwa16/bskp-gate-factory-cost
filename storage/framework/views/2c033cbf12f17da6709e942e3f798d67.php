...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid py-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <form action="<?php echo e(route('dashboard')); ?>" method="GET" class="d-flex gap-2 enterprise-toolbar align-items-center">
        ...
        <div class="d-flex justify-content-between align-items-end mb-3 mt-2">
            <div>
                ...
                <small class="text-muted">Akumulasi pencapaian s.d. tanggal:
                    <strong><?php echo e(\Carbon\Carbon::parse($toDate)->translatedFormat('d F Y')); ?></strong></small>
            </div>
        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h3 class="mb-0 fw-bold text-dark">
                                    <?php echo e(number_format($kpiProduksi['produksi_kg'], 0, ',', '.')); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <p class="mb-1 text-muted small fw-bold text-uppercase" style="letter-spacing: 0.5px;">Total
                                    Aktual HK</p>
                                <h3 class="mb-0 fw-bold text-dark">
                                    <?php echo e(number_format($kpiProduksi['total_hk'], 1, ',', '.')); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <p class="mb-1 text-muted small fw-bold text-uppercase" style="letter-spacing: 0.5px;">
                                    Produktivitas</p>
                                <h3 class="mb-0 fw-bold text-dark">
                                    <?php echo e(number_format($kpiProduksi['kg_per_hk'], 2, ',', '.')); ?>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h3 class="mb-0 fw-bold text-dark">
                                    <span
                                        class="fs-6 fw-normal text-muted me-1">Rp</span><?php echo e(number_format($kpiProduksi['rp_per_kg'], 0, ',', '.')); ?><span
                        ...
                        <div class="mt-3 d-flex align-items-center">
                            <span class="badge <?php echo e($badgeColor); ?> shadow-sm px-2 py-1 me-2"
                                style="font-size: 12px; border-radius: 6px;">
                                <i
                                    class="bi <?php echo e($iconDir); ?> me-1"></i><?php echo e($pct > 0 ? number_format($pct, 1, ',', '.') : '0'); ?>%
                            </span>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0 align-middle text-center" style="font-size: 13px;">
                        ...
                        <tbody class="border-top-0">
                            <?php $__currentLoopData = ['Regular', 'Contract FL', 'Total']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $p = $mtdData[$cat]['plan'];
                                ...
                                ?>
                                <tr class="<?php echo e($cat == 'Total' ? 'bg-light fw-bold' : ''); ?>">
                                    <td
                                        class="text-start ps-4 <?php echo e($cat == 'Total' ? 'text-dark' : 'text-secondary fw-medium'); ?>">
                                        <?php echo e($cat); ?></td>
                                    <td class="text-primary">Rp <?php echo e(number_format($p, 0, ',', '.')); ?></td>
                                    <td class="text-info">Rp <?php echo e(number_format($a, 0, ',', '.')); ?></td>
                                    <td class="<?php echo e($sisa < 0 ? 'text-danger fw-bold' : 'text-success fw-bold'); ?>">
                                        Rp <?php echo e(number_format($sisa, 0, ',', '.')); ?>

                                    </td>
                                    <td class="pe-4"><?php echo $statusBadge; ?></td>
                                </tr>
        ...
        <div class="card shadow-sm border-0 mb-4" style="border-radius: 12px;">
            ...
            <div class="card-body p-4">
                ...
                <div class="row mt-4">
                    <?php $__currentLoopData = $dailyTrendPerArea; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $areaName => $chartData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-xl-6 col-lg-12 mb-4">
                            <div class="card shadow-sm border-0 h-100">
                                <div class="card-header bg-white border-bottom-0 pt-3 pb-0">
                                    <h6 class="fw-bold mb-0 text-dark"><i
                                            class="bi bi-graph-up text-primary me-2"></i>Daily Trend: <?php echo e($areaName); ?>
                                ...
                                <div class="card-body">
                                    <div style="height: 300px;">
                                        <canvas id="chart-<?php echo e(Str::slug($areaName)); ?>"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-regular" role="tabpanel">
                <?php echo $__env->make('dashboard.partials.content', [
                    'data' => $dataRegular,
                    'id_suffix' => 'Reg',
                    'color' => '#0d6efd',
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const trendData = <?php echo json_encode($dailyTrend, 15, 512) ?>;
            ...
            if (document.getElementById('dashboardCpkChart')) {
                ...
                const labelsCpk = <?php echo json_encode($chartCpk['labels'], 15, 512) ?>;
                const dataActualCpk = <?php echo json_encode($chartCpk['actual'], 15, 512) ?>;
                const dataTargetCpk = <?php echo json_encode($chartCpk['target'], 15, 512) ?>;
            ...
            const chartsData = <?php echo json_encode($dailyTrendPerArea, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Anshari\App\bskp-gate-factory-cost\resources\views/dashboard/index.blade.php ENDPATH**/ ?>