<?php $__env->startSection('title', 'Input Potongan Gaji'); ?>
<?php $__env->startSection('page-title', 'Input Potongan Gaji'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid py-3">
        <div class="filter-box d-flex justify-content-between align-items-center">
            <h5 class="m-0 fw-bold text-secondary">
                ...
                <span class="text-primary"><?php echo e(\Carbon\Carbon::create($year, $month)->translatedFormat('F Y')); ?></span>
            </h5>
            <div>
                <form action="<?php echo e(route('deduction.index')); ?>" method="GET" class="d-flex gap-2 mb-0">
            ...
            <table class="table ts-table mb-0">
                ...
                <tbody>
                    <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <tr>
                            <td class="sticky-left col-no text-muted"><?php echo e($index + 1); ?></td>
                            <td class="sticky-left col-name">
                                <div class="fw-bold text-dark" style="font-size: 12px;"><?php echo e($emp->name); ?></div>
                                <div class="text-muted" style="font-size: 10px; margin-top: 1px;"><?php echo e($emp->nik); ?> -
                                    <?php echo e($emp->status); ?></div>
                            </td>
                            <td class="sticky-left col-jabatan text-muted"><?php echo e($emp->jabatan); ?></td>

                            <td>
                                <input type="number" class="excel-input" placeholder="0"
                                    value="<?php echo e($data && $data->spsi > 0 ? $data->spsi : ''); ?>"
                                    onchange="saveDeduction(this, '<?php echo e($emp->nik); ?>', 'spsi')">
                            </td>
                            <td>
                                <input type="number" class="excel-input" placeholder="0"
                                    value="<?php echo e($data && $data->astek > 0 ? $data->astek : ''); ?>"
                                    onchange="saveDeduction(this, '<?php echo e($emp->nik); ?>', 'astek')">
                            </td>
                            <td>
                                <input type="number" class="excel-input" placeholder="0"
                                    value="<?php echo e($data && $data->listrik > 0 ? $data->listrik : ''); ?>"
                                    onchange="saveDeduction(this, '<?php echo e($emp->nik); ?>', 'listrik')">
                            </td>
                            <td>
                                <input type="number" class="excel-input" placeholder="0"
                                    value="<?php echo e($data && $data->kantin > 0 ? $data->kantin : ''); ?>"
                                    onchange="saveDeduction(this, '<?php echo e($emp->nik); ?>', 'kantin')">
                            </td>
                            <td>
                                <input type="number" class="excel-input" placeholder="0"
                                    value="<?php echo e($data && $data->spd_motor > 0 ? $data->spd_motor : ''); ?>"
                                    onchange="saveDeduction(this, '<?php echo e($emp->nik); ?>', 'spd_motor')">
                            </td>
                            <td>
                                <input type="number" class="excel-input" placeholder="0"
                                    value="<?php echo e($data && $data->bank > 0 ? $data->bank : ''); ?>"
                                    onchange="saveDeduction(this, '<?php echo e($emp->nik); ?>', 'bank')">
                            </td>
                            <td>
                                <input type="number" class="excel-input" placeholder="0"
                                    value="<?php echo e($data && $data->other > 0 ? $data->other : ''); ?>"
                                    onchange="saveDeduction(this, '<?php echo e($emp->nik); ?>', 'other')">
                            </td>
                        </tr>
    ...
    <script>
        function saveDeduction(inputElement, nik, field) {
            ...
            const period = "<?php echo e($period); ?>"; // Contoh: "2026-05"

            fetch("<?php echo e(route('deduction.update')); ?>", {
                    method: "POST",
                    headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/bskp-gate-factory-cost/resources/views/deduction-wages/index.blade.php ENDPATH**/ ?>