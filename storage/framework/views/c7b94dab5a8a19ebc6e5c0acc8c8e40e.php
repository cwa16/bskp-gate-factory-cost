...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid py-4 enterprise-container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <form action="<?php echo e(route('cost-per-kg.index')); ?>" method="GET"
                ...
                <div class="form-check form-switch ms-2 me-2 mb-0 d-flex align-items-center">
                    <input class="form-check-input mt-0 me-2" type="checkbox" role="switch" id="kpiModeSwitch"
                        name="kpi_mode" value="1" <?php echo e(request('kpi_mode') == '1' ? 'checked' : ''); ?>
                ...
                <select name="type" class="form-select form-select-sm fw-bold border-0 bg-light text-primary">
                    <option value="gabungan" <?php echo e(request('type') == 'gabungan' ? 'selected' : ''); ?>>Regular + Contract FL
                    </option>
                    <option value="regular" <?php echo e(request('type') == 'regular' ? 'selected' : ''); ?>>Hanya Regular</option>
                    <option value="contract_fl" <?php echo e(request('type') == 'contract_fl' ? 'selected' : ''); ?>>Hanya Contract FL
                    </option>
                </select>
                ...
                <a href="<?php echo e(route('cost-per-kg.export', ['month' => $month, 'year' => $year, 'type' => $type, 'kpi_mode' => request('kpi_mode')])); ?>"
                ...
                <thead>
                    <tr>
                        ...
                        <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                            <th class="<?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $areaName => $prodLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="row-cost-budget">
                            <td class="sticky-col-1"><?php echo e($no++); ?></td>
                            ...
                            <td class="sticky-col-4 pe-3">
                                <?php echo e($rowTtdBudgetCost > 0 ? number_format($rowTtdBudgetCost, 0, ',', '.') : '-'); ?></td>
                            <td class="sticky-col-5 pe-3">
                                <?php echo e($rowTotalBudgetCost > 0 ? number_format($rowTotalBudgetCost, 0, ',', '.') : '-'); ?></td>
                            <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                                <td class="text-end val-cell <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                    <?php echo e(($budgetCostsPerAreaDay[$areaName][$d] ?? 0) > 0 ? number_format($budgetCostsPerAreaDay[$areaName][$d], 0, ',', '.') : '-'); ?>
                        ...
                        <tr class="row-cost-actual">
                            ...
                            <td class="sticky-col-2 ps-4 border-top-0">Actual Cost <?php echo e($areaName); ?></td>
                            <td class="sticky-col-3 border-top-0">Rp</td>
                            <td class="sticky-col-4 text-primary pe-3">
                                <?php echo e($rowTtdCost > 0 ? number_format($rowTtdCost, 0, ',', '.') : '-'); ?></td>
                            <td class="sticky-col-5 text-primary pe-3">
                                <?php echo e($rowTotalCost > 0 ? number_format($rowTotalCost, 0, ',', '.') : '-'); ?></td>
                            <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                                <td class="text-end val-cell <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                    <?php echo e(($costsPerAreaDay[$areaName][$d] ?? 0) > 0 ? number_format($costsPerAreaDay[$areaName][$d], 0, ',', '.') : '-'); ?>
                        ...
                        <tr class="row-sub-percent">
                            ...
                            <td class="sticky-col-4 pe-3 fw-bold <?php echo e($pctClassTtdCost); ?>">
                                <?php echo e($rowTtdCostPct > 0 ? number_format($rowTtdCostPct, 1, ',', '.') . '%' : '-'); ?></td>
                            <td class="sticky-col-5 pe-3 fw-bold <?php echo e($pctClassTotalCost); ?>">
                                <?php echo e($rowTotalCostPct > 0 ? number_format($rowTotalCostPct, 1, ',', '.') . '%' : '-'); ?></td>
                            <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                                <?php
                                ...
                                ?>
                                <td
                                    class="text-end border-bottom-0 fw-bold <?php echo e($cClass); ?> <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                    <?php echo e($cPct > 0 ? number_format($cPct, 1, ',', '.') . '%' : '-'); ?></td>
                            <?php endfor; ?>
                        </tr>
                        ...
                        <tr class="row-budget-production">
                            ...
                            <td class="sticky-col-2 ps-4 border-top-0"><i class="bi bi-bullseye me-1 opacity-50"></i>Budget
                                Produksi <?php echo e($prodLabel); ?></td>
                            <td class="sticky-col-3 border-top-0">Kg</td>
                            <td class="sticky-col-4 pe-3">
                                <?php echo e($rowTtdBudgetProd > 0 ? number_format($rowTtdBudgetProd, 0, ',', '.') : '-'); ?></td>
                            <td class="sticky-col-5 pe-3">
                                <?php echo e($rowTotalBudgetProd > 0 ? number_format($rowTotalBudgetProd, 0, ',', '.') : '-'); ?></td>
                            <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                                <td
                                    class="text-end border-top-0 <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                    <?php echo e(($budgetProd[$areaName][$d] ?? 0) > 0 ? number_format($budgetProd[$areaName][$d], 0, ',', '.') : '-'); ?>
                        ...
                        <tr class="row-production">
                            ...
                            <td class="sticky-col-3 border-top-0">Kg</td>
                            <td class="sticky-col-4 pe-3">
                                <?php echo e($rowTtdProd > 0 ? number_format($rowTtdProd, 0, ',', '.') : '-'); ?></td>
                            <td class="sticky-col-5 pe-3">
                                <?php echo e($rowTotalProd > 0 ? number_format($rowTotalProd, 0, ',', '.') : '-'); ?></td>
                            <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                                <td
                                    class="text-end border-top-0 <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                    <?php echo e(($actualProd[$areaName][$d] ?? 0) > 0 ? number_format($actualProd[$areaName][$d], 0, ',', '.') : '-'); ?>
                        ...
                        <tr class="row-sub-percent">
                            ...
                            <td class="sticky-col-3 border-bottom-0">%</td>
                            <td class="sticky-col-4 pe-3 fw-bold <?php echo e($pctClassTtdProd); ?>">
                                <?php echo e($rowTtdProdPct > 0 ? number_format($rowTtdProdPct, 1, ',', '.') . '%' : '-'); ?></td>
                            <td class="sticky-col-5 pe-3 fw-bold <?php echo e($pctClassTotalProd); ?>">
                                <?php echo e($rowTotalProdPct > 0 ? number_format($rowTotalProdPct, 1, ',', '.') . '%' : '-'); ?></td>
                            <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                                <?php
                                ...
                                ?>
                                <td
                                    class="text-end border-bottom-0 fw-bold <?php echo e($pClass); ?> <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                    <?php echo e($pPct > 0 ? number_format($pPct, 1, ',', '.') . '%' : '-'); ?></td>
                            <?php endfor; ?>
                        </tr>
                        ...
                        <tr class="row-budget">
                            ...
                            <td class="sticky-col-4 pe-3">
                                <?php echo e($rowTtdBudgetCpk > 0 ? number_format($rowTtdBudgetCpk, 2, ',', '.') : '-'); ?></td>
                            <td class="sticky-col-5 pe-3">
                                <?php echo e($rowTotalBudgetCpk > 0 ? number_format($rowTotalBudgetCpk, 2, ',', '.') : '-'); ?></td>
                            <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                                <?php
                                    $bCost = $budgetCostsPerAreaDay[$areaName][$d] ?? 0;
                                    $bProd = $budgetProd[$areaName][$d] ?? 0;
                                ...
                                ?>
                                <td
                                    class="text-end border-bottom-0 fw-medium <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                    <?php echo e($bCpk > 0 ? number_format($bCpk, 2, ',', '.') : '-'); ?></td>
                            <?php endfor; ?>
                        </tr>
                        ...
                        <tr class="row-cost-kg">
                            ...
                            <td class="sticky-col-4 val-cell pe-3">
                                <?php echo e($rowTtdActualCpk > 0 ? number_format($rowTtdActualCpk, 2, ',', '.') : '-'); ?></td>
                            <td class="sticky-col-5 val-cell pe-3">
                                <?php echo e($rowTotalActualCpk > 0 ? number_format($rowTotalActualCpk, 2, ',', '.') : '-'); ?></td>
                            <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                                <?php $cpk = ($actualProd[$areaName][$d] ?? 0) > 0 ? ($costsPerAreaDay[$areaName][$d] ?? 0) / $actualProd[$areaName][$d] : 0; ?>
                                <td
                                    class="text-end border-bottom-0 val-cell <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                    <?php echo e($cpk > 0 ? number_format($cpk, 2, ',', '.') : '-'); ?></td>
                            <?php endfor; ?>
                        </tr>
                        ...
                        <tr class="row-percent">
                            ...
                            <td class="sticky-col-4 pe-3 <?php echo e($pctClassTtdCpk); ?>">
                                <?php echo e($rowTtdCpkPercent > 0 ? number_format($rowTtdCpkPercent, 1, ',', '.') . '%' : '-'); ?>

                            </td>
                            <td class="sticky-col-5 pe-3 <?php echo e($pctClassTotalCpk); ?>">
                                <?php echo e($rowTotalCpkPercent > 0 ? number_format($rowTotalCpkPercent, 1, ',', '.') . '%' : '-'); ?>
                            ...
                            <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                                ...
                                ?>
                                <td
                                    class="text-end border-bottom fw-bold <?php echo e($textClass); ?> <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                    <?php echo e($percent > 0 ? number_format($percent, 1, ',', '.') . '%' : '-'); ?></td>
                            <?php endfor; ?>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    <tr>
                        <td colspan="<?php echo e(5 + $daysInMonth); ?>"
                    ...
                    <tr class="row-cost-budget" style="border-top: 3px solid #cbd5e1;">
                        ...
                        <td class="sticky-col-4 pe-3" style="border-top: 3px solid #cbd5e1;">
                            <?php echo e($grandTtdBudgetCost > 0 ? number_format($grandTtdBudgetCost, 0, ',', '.') : '-'); ?></td>
                        <td class="sticky-col-5 pe-3" style="border-top: 3px solid #cbd5e1;">
                            <?php echo e($grandTotalBudgetCost > 0 ? number_format($grandTotalBudgetCost, 0, ',', '.') : '-'); ?></td>
                        <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                            <?php
                                $tBudgetCostDay = 0;
                                foreach (array_keys($areas) as $a) {
                            ...
                            <td class="text-end val-cell <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>"
                                ...
                                <?php echo e($tBudgetCostDay > 0 ? number_format($tBudgetCostDay, 0, ',', '.') : '-'); ?>
                    ...
                    <tr class="row-cost-actual">
                        ...
                        <td class="sticky-col-3 border-top-0">Rp</td>
                        <td class="sticky-col-4 text-primary pe-3">
                            <?php echo e($grandTtdCost > 0 ? number_format($grandTtdCost, 0, ',', '.') : '-'); ?></td>
                        <td class="sticky-col-5 text-primary pe-3">
                            <?php echo e($grandTotalCost > 0 ? number_format($grandTotalCost, 0, ',', '.') : '-'); ?></td>
                        <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                            <?php
                                $tCostDay = 0;
                                foreach (array_keys($areas) as $a) {
                            ...
                            ?>
                            <td class="text-end val-cell <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                <?php echo e($tCostDay > 0 ? number_format($tCostDay, 0, ',', '.') : '-'); ?>
                    ...
                    <tr class="row-footer-percent">
                        ...
                        <td class="sticky-col-3 border-bottom-0">%</td>
                        <td class="sticky-col-4 pe-3 fw-bold <?php echo e($pctClassGrandTtdCost); ?>">
                            <?php echo e($grandTtdCostPct > 0 ? number_format($grandTtdCostPct, 1, ',', '.') . '%' : '-'); ?></td>
                        <td class="sticky-col-5 pe-3 fw-bold <?php echo e($pctClassGrandTotalCost); ?>">
                            <?php echo e($grandTotalCostPct > 0 ? number_format($grandTotalCostPct, 1, ',', '.') . '%' : '-'); ?></td>
                        <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                            <?php
                                $tCostDay = 0;
                                $tBudgetCostDay = 0;
                    ...
                    <tr class="row-budget-production">
                        ...
                        <td class="sticky-col-3 border-top-0">Kg</td>
                        <td class="sticky-col-4 pe-3">
                            <?php echo e($grandTtdBudgetRss > 0 ? number_format($grandTtdBudgetRss, 0, ',', '.') : '-'); ?></td>
                        <td class="sticky-col-5 pe-3">
                            <?php echo e($grandTotalBudgetRss > 0 ? number_format($grandTotalBudgetRss, 0, ',', '.') : '-'); ?></td>
                        <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                            <td
                                class="text-end border-top-0 <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                <?php echo e(($budgetTotalRss[$d] ?? 0) > 0 ? number_format($budgetTotalRss[$d], 0, ',', '.') : '-'); ?>
                    ...
                    <tr class="row-production">
                        ...
                        <td class="sticky-col-3 border-top-0">Kg</td>
                        <td class="sticky-col-4 pe-3">
                            <?php echo e($grandTtdRss > 0 ? number_format($grandTtdRss, 0, ',', '.') : '-'); ?></td>
                        <td class="sticky-col-5 pe-3">
                            <?php echo e($grandTotalRss > 0 ? number_format($grandTotalRss, 0, ',', '.') : '-'); ?></td>
                        <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                            <td
                                class="text-end border-top-0 <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                <?php echo e(($actualTotalRss[$d] ?? 0) > 0 ? number_format($actualTotalRss[$d], 0, ',', '.') : '-'); ?>
                    ...
                    <tr class="row-footer-percent">
                        ...
                        <td class="sticky-col-3 border-bottom-0">%</td>
                        <td class="sticky-col-4 pe-3 fw-bold <?php echo e($pctClassGrandTtdProd); ?>">
                            <?php echo e($grandTtdProdPct > 0 ? number_format($grandTtdProdPct, 1, ',', '.') . '%' : '-'); ?></td>
                        <td class="sticky-col-5 pe-3 fw-bold <?php echo e($pctClassGrandTotalProd); ?>">
                            <?php echo e($grandTotalProdPct > 0 ? number_format($grandTotalProdPct, 1, ',', '.') . '%' : '-'); ?></td>
                        <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                            <?php
                    ...
                    <tr class="row-budget">
                        ...
                        <td class="sticky-col-3 border-bottom-0">Rp</td>
                        <td class="sticky-col-4 pe-3">
                            <?php echo e($grandTtdBudgetCpk > 0 ? number_format($grandTtdBudgetCpk, 2, ',', '.') : '-'); ?></td>
                        <td class="sticky-col-5 pe-3">
                            <?php echo e($grandTotalBudgetCpk > 0 ? number_format($grandTotalBudgetCpk, 2, ',', '.') : '-'); ?></td>
                        <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                            <?php
                                $tBudgetCostDay = 0;
                                foreach (array_keys($areas) as $a) {
                            ...
                            <td
                                class="text-end border-bottom-0 fw-medium <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                <?php echo e($finalBudgetCpk > 0 ? number_format($finalBudgetCpk, 2, ',', '.') : '-'); ?>
                    ...
                    <tr class="row-cost-kg">
                        ...
                        <td class="sticky-col-3 border-bottom-0">Rp</td>
                        <td class="sticky-col-4 val-cell pe-3">
                            <?php echo e($grandTtdActualCpk > 0 ? number_format($grandTtdActualCpk, 2, ',', '.') : '-'); ?></td>
                        <td class="sticky-col-5 val-cell pe-3">
                            <?php echo e($grandTotalActualCpk > 0 ? number_format($grandTotalActualCpk, 2, ',', '.') : '-'); ?></td>
                        <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                            <?php
                                $tCostDay = 0;
                                foreach (array_keys($areas) as $a) {
                            ...
                            <td
                                class="text-end border-bottom-0 val-cell <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                <?php echo e($finalCpk > 0 ? number_format($finalCpk, 2, ',', '.') : '-'); ?>
                    ...
                    <tr class="row-percent">
                        ...
                        <td class="sticky-col-3 border-bottom text-dark fw-bold">%</td>
                        <td class="sticky-col-4 pe-3 <?php echo e($pctClassGrandTtdCpk); ?>">
                            <?php echo e($grandTtdCpkPercent > 0 ? number_format($grandTtdCpkPercent, 1, ',', '.') . '%' : '-'); ?>

                        </td>
                        <td class="sticky-col-5 pe-3 <?php echo e($pctClassGrandTotalCpk); ?>">
                            <?php echo e($grandTotalCpkPercent > 0 ? number_format($grandTotalCpkPercent, 1, ',', '.') . '%' : '-'); ?>
                        ...
                        <?php for($d = 1; $d <= $daysInMonth; $d++): ?>
                            ...
                            <td
                                class="text-end border-bottom fw-bold <?php echo e($textClass); ?> <?php echo e($d == $ttdDay ? 'border-end border-info border-2' : ''); ?>">
                                <?php echo e($percent > 0 ? number_format($percent, 1, ',', '.') . '%' : '-'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Anshari\App\bskp-gate-factory-cost\resources\views/cost-per-kg/index.blade.php ENDPATH**/ ?>